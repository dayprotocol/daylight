...
|--------|----------|--------|
| `day-venues.v1.json` | Hosted venue readiness producer → `listVenueReadiness` | Phase 1 Sui + Solana venues, readiness + mock/live APY (producer implementation is private; schema only is public) |
